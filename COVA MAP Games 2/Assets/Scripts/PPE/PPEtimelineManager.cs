...
public class PPEtimelineManager : MonoBehaviour
{
    public string PPE; // The name of the scene to load after the timeline finishes.
    ...
    private void LoadNewScene()
    {
        ...
        SceneManager.LoadSceneAsync("PPE");
    }
}
